...
import { deleteShipmentDetails } from '../../store/actions/ShipmentAction';
                    ...
                    <div className="row">
                        ...
                        <div className="col">
                            <div className="container" style={{ fontFamily: "cursive", fontSize: "25px", color: "silver" }}>
                                ...
                                <p>Shipment Assets : {shipment.shipmentAssets}</p>
                                <p>Shipment status : {shipment.shipmentStatus}</p>
                                <p>ShipmentSub-Location : {shipment.shipmentSubLocation}</p>
                                <p>ShipmentDate : {shipment.shipmentDate}</p>
                                <p>ShipmentLocation : {shipment.shipmentLocation}</p>
                                ...
                                <Link to={`/shipment/edit/${shipment.shipmentId}`}><button style={{ float: "left" }} className="btn btn-primary">Edit</button></Link>
